...
<div class="row">
   <div class="col-12">
      <div class="card">
         ...
         <div class="card-body">
            <form action="/toko/save/fromToko" method="post">
               <?= csrf_field(); ?>
               ...
               <div class="form-group row mb-4">
                  ...
                  <div class="col-sm-12 col-md-7">
                     <textarea type="text" class="form-control <?= ($validation->hasError('alamat') ? 'is-invalid' : ''); ?>" name="alamat" id="alamat"><?= old('alamat'); ?></textarea>
                     <div class="invalid-feedback">
